  ...
  return (
    <section className="flex flex-row justify-between">
      <div className="flex flex-col items-end gap-1">
        <span className="text-[#065b52] text-sm font-bold flex justify-start w-full ">
          {title}
        </span>
        {/* <span className="text-[#bb5327] text-sm font-normal flex justify-start w-full">
          {price.toLocaleString("fa-IR")} هزار تومان
        </span> */}
        <span className="text-[#065b52]  text-sm font-normal flex justify-start w-full">
                {itemTotal.toLocaleString("fa-IR")} هزار تومان
        </span>
      </div>
      <div className="flex flex-row gap-2 items-center justify-between">
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M5 13.5V11.5H19V13.5H5Z" fill="#000000" />
          </svg>
        </button>
